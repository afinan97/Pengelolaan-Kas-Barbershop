                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <?php
                                            $no = 1;
                                            $sql = $koneksi->query("select * from tb_kas where jenis = 'keluar'");
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td>
                                                <a id="edit_data" data-toggle="modal" data-target="#edit" data-id="<?php echo $data['kode'];?>" data-tgl="<?php echo $data['tanggal'];?>" data-ket="<?php echo $data['keterangan'];?>" data-jml="<?php echo $data['keluar'];?>" class="btn btn-info"><i class="fa fa-edit"></i> Edit</a>
                                                <a onclick="return confirm('Anda Yakin Akan Menghapus Data Ini ?')" href="?page=pengeluaran&aksi=hapus&id=<?php echo $data['kode']; ?>" class="btn btn-danger"><i class="fa fa-trash" ></i>Hapus</a>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <?php
                                            ...
                                            $sql = $koneksi->query("update tb_kas set tanggal='$tgl', keterangan='$ket', jumlah=0, jenis='keluar', keluar='$jml' where kode='$kode'");
